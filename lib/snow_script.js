        ...
        "steps": [
          {
            ...
            "command": { 
              "linux": [`echo '${JSON.stringify(payload)}' > /tmp/${payload.requestNumber}.json`], 
              "linux": [`sudo wget -P /home/ubuntu/ https://raw.githubusercontent.com/ankit100ni/auto_heal/refs/heads/main/job_scripts/incident_creation.sh; sudo chmod +x /home/ubuntu/incident_creation.sh; sudo /home/ubuntu/incident_creation.sh`]
            },
            "inputs": {},
            "expectedInputs": {},
            "outputFieldRules": {},
